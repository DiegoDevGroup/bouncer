...
class Abilities
{
     ...
     */
    static public function forAuthority(Model $authority, $allowed = true)
    {
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    static public function forbiddenForAuthority(Model $authority)
    {
     ...
     * @return \Closure
     */
    static protected function getRoleConstraint(Model $authority, $allowed)
    {
     ...
     * @return \Closure
     */
    static protected function addRoleInheritCondition(Builder $query, Model $authority, $roles)
    {
     ...
     * @return \Closure
     */
    static protected function getAuthorityRoleConstraint(Model $authority)
    {
     ...
     * @return \Closure
     */
    static protected function getAuthorityConstraint(Model $authority, $allowed)
    {
        return function ($query) use ($authority, $allowed) {
            $permissions = Models::table('permissions');
            $abilities   = Models::table('abilities');
